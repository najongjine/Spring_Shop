...
/*
 * Spring Sec 와 연동하여 회원정보를 관리하기 위한 UserVO는
 * 단독으로 작성하지 않고
 * 
 * UserDetail 이라는 인터페이스를 implements 하여 작성한다.
 * 
 * Spring Sec에서 제공하는 User 클래스를 상속하여 사용.
 * 
 * UserVO는 인스턴스를 생성할때 생성자를 사용하여 초기값을 설정하도록 디자인 되어있다.
 */
public class UserVO extends User {
	...
	public UserVO(String username, String password, boolean enabled, String email, String phone, String addr, 
			//int age,
