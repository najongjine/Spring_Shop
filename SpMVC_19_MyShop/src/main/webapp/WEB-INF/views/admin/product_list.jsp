...
$(function() {
	/*
	클래스 prol_tr은 본문의 tr tag에 설정이 되어 있고
	본문의 tr tag를 클릭하면 이벤트가 발생하고 함수가 실행된다.
	
	이때 tr tag가 갖는 모든 정보는 this라는 내장 객체에 담겨 함수 내부로 전달된다.
	*/
	/*
	tr tag가 클릭되면 id값을 추출하고 update method로 전달하기
	*/
...
<table class="col-md4 col-12">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<tr class="pro_tr context-menu-one "  data-id="${PRO.id }">
				<td>${PRO.p_code}</td>
