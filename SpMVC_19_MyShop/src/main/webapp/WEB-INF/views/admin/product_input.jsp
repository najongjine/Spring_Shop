...
<form:form action="${rootPath }/admin/product/detail" modelAttribute="productVO">
			<div class="form-group">
				<form:select path="p_pcode" class="custom-select-sm">
				...
				<form:errors path="p_pcode" class="in-errors"/>
			</div>	
			
			<div class="form-group">
				<form:input path="p_dcode" class="custom-select-sm col-6" placeholder="거래처 코드"/>
				<span id="d_name"></span>
