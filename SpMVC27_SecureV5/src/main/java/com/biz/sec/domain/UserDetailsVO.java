...
/**
 * Spring Sec 와 연동하여 회원정보를 관리하기 위한 UserDetailsVO는
 * 단독으로 작성하지 않고
 * 
 ...
 * 
 * UserDetails를 implements 하면 method를 Overide 하라는 지시가 있다.
 * 하지만, method를 override하지않고 필드변수들을 선언하고 lombok의 gettersetter를 선언해준다.
 * 
